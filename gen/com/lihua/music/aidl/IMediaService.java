 ...
 * Original file: E:\\workspeces\\Lihua-Music\\src\\com\\lihua\\music\\aidl\\IMediaService.aidl
 */
package com.lihua.music.aidl;
public interface IMediaService extends android.os.IInterface
{
/** Local-side IPC implementation stub class. */
public static abstract class Stub extends android.os.Binder implements com.lihua.music.aidl.IMediaService
{
private static final java.lang.String DESCRIPTOR = "com.lihua.music.aidl.IMediaService";
...
/**
 * Cast an IBinder object into an com.lihua.music.aidl.IMediaService interface,
 * generating a proxy if needed.
 */
public static com.lihua.music.aidl.IMediaService asInterface(android.os.IBinder obj)
{
if ((obj==null)) {
return null;
}
android.os.IInterface iin = obj.queryLocalInterface(DESCRIPTOR);
if (((iin!=null)&&(iin instanceof com.lihua.music.aidl.IMediaService))) {
return ((com.lihua.music.aidl.IMediaService)iin);
}
return new com.lihua.music.aidl.IMediaService.Stub.Proxy(obj);
}
...
{
data.enforceInterface(DESCRIPTOR);
java.util.List<com.lihua.music.model.MusicInfo> _arg0;
_arg0 = data.createTypedArrayList(com.lihua.music.model.MusicInfo.CREATOR);
...
data.enforceInterface(DESCRIPTOR);
java.util.List<com.lihua.music.model.MusicInfo> _arg0;
_arg0 = new java.util.ArrayList<com.lihua.music.model.MusicInfo>();
...
{
data.enforceInterface(DESCRIPTOR);
com.lihua.music.model.MusicInfo _result = this.getCurMusic();
reply.writeNoException();
if ((_result!=null)) {
reply.writeInt(1);
...
private static class Proxy implements com.lihua.music.aidl.IMediaService
{
...
@Override public void refreshMusicList(java.util.List<com.lihua.music.model.MusicInfo> musicList) throws android.os.RemoteException
{
android.os.Parcel _data = android.os.Parcel.obtain();
android.os.Parcel _reply = android.os.Parcel.obtain();
try {
...
@Override public void getMusicList(java.util.List<com.lihua.music.model.MusicInfo> musicList) throws android.os.RemoteException
{
android.os.Parcel _data = android.os.Parcel.obtain();
android.os.Parcel _reply = android.os.Parcel.obtain();
try {
...
_reply.readException();
_reply.readTypedList(musicList, com.lihua.music.model.MusicInfo.CREATOR);
}
finally {
_reply.recycle();
_data.recycle();
...
@Override public com.lihua.music.model.MusicInfo getCurMusic() throws android.os.RemoteException
{
android.os.Parcel _data = android.os.Parcel.obtain();
android.os.Parcel _reply = android.os.Parcel.obtain();
com.lihua.music.model.MusicInfo _result;
try {
_data.writeInterfaceToken(DESCRIPTOR);
mRemote.transact(Stub.TRANSACTION_getCurMusic, _data, _reply, 0);
_reply.readException();
if ((0!=_reply.readInt())) {
_result = com.lihua.music.model.MusicInfo.CREATOR.createFromParcel(_reply);
}
else {
_result = null;
}
...
static final int TRANSACTION_duration = (android.os.IBinder.FIRST_CALL_TRANSACTION + 7);
static final int TRANSACTION_position = (android.os.IBinder.FIRST_CALL_TRANSACTION + 8);
static final int TRANSACTION_seekTo = (android.os.IBinder.FIRST_CALL_TRANSACTION + 9);
static final int TRANSACTION_refreshMusicList = (android.os.IBinder.FIRST_CALL_TRANSACTION + 10);
static final int TRANSACTION_getMusicList = (android.os.IBinder.FIRST_CALL_TRANSACTION + 11);
static final int TRANSACTION_getPlayState = (android.os.IBinder.FIRST_CALL_TRANSACTION + 12);
static final int TRANSACTION_getPlayMode = (android.os.IBinder.FIRST_CALL_TRANSACTION + 13);
static final int TRANSACTION_setPlayMode = (android.os.IBinder.FIRST_CALL_TRANSACTION + 14);
static final int TRANSACTION_sendPlayStateBrocast = (android.os.IBinder.FIRST_CALL_TRANSACTION + 15);
static final int TRANSACTION_exit = (android.os.IBinder.FIRST_CALL_TRANSACTION + 16);
static final int TRANSACTION_getCurMusicId = (android.os.IBinder.FIRST_CALL_TRANSACTION + 17);
static final int TRANSACTION_updateNotification = (android.os.IBinder.FIRST_CALL_TRANSACTION + 18);
static final int TRANSACTION_cancelNotification = (android.os.IBinder.FIRST_CALL_TRANSACTION + 19);
static final int TRANSACTION_getCurMusic = (android.os.IBinder.FIRST_CALL_TRANSACTION + 20);
}
...
public void refreshMusicList(java.util.List<com.lihua.music.model.MusicInfo> musicList) throws android.os.RemoteException;
public void getMusicList(java.util.List<com.lihua.music.model.MusicInfo> musicList) throws android.os.RemoteException;
...
public com.lihua.music.model.MusicInfo getCurMusic() throws android.os.RemoteException;
}
