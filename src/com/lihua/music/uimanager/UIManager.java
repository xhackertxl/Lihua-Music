...
import com.lihua.music.activity.MainActivity;
import com.lihua.music.activity.MainContentActivity;
import com.lihua.music.activity.MainContentActivity.OnBackListener;
...
public class UIManager implements IConstants, OnBackListener {
	...
	public MainUIManager mMainUIManager;
	...
	private void init() {
		...
		WallpaperManager myWallpaperManager = WallpaperManager.getInstance(mMainActivity);
		Drawable dr = myWallpaperManager.getDrawable();

		mViewPager.setBackground(dr);
		mViewPagerSub.setBackground(dr);
	...
	public void setCurrentItem() {
		if (mViewPagerSub.getChildCount() > 0) {
			mViewPagerSub.setCurrentItem(0, false);
		} else {
	...
	public void setContentType(int type, Object obj) {
		...
		case FOLDER_TO_MYMUSIC:
			...
			mViewPagerSub.setCurrentItem(1, false);
	...
	private class MyOnPageChangeListenerSub implements OnPageChangeListener {
		...
		public void onPageScrollStateChanged(int arg0) {
			if (onPageScrolled == 0 && arg0 == 0) {
				System.out.println("onPageScrollStateChanged2--->" + arg0);
				mViewPagerSub.removeAllViews();
