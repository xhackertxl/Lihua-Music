...
public interface IConstants {
	...
	public static final String BROADCAST_NAME = "com.lihua.music.broadcast";
	public static final String SERVICE_NAME = "com.lihua.music.service.MediaService";
	public static final String BROADCAST_QUERY_COMPLETE_NAME = "com.lihua.music.querycomplete.broadcast";
	public static final String BROADCAST_CHANGEBG = "com.lihua.music.changebg";
	public static final String BROADCAST_SHAKE = "com.lihua.music.shake";
	
	//是否开启了振动模式
	public static final String SHAKE_ON_OFF = "SHAKE_ON_OFF";
	
	public static final String SP_NAME = "com.lihua.music_preference";
	...
	public static final int MPS_STOP = 4; // 暂停
