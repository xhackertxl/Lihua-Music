...
public class MusicControl implements IConstants, OnCompletionListener {
	...
	public boolean stop() {
		...
		mStopPlayIndex = mCurPlayIndex;

		Log.d(TAG, "stop = mCurPlayIndex =" + mStopPlayIndex);
	 ...
	 * 
	 * @param progress
	 *            这个参数 设置MAX的时候 换算的单位是秒 , seekto的单位是毫秒 所以要乘以 1000
	 * @return
	 */
