 ...
 */
package com.lihua.music.service;
...
import com.lihua.music.shake.ShakeDetector;
import com.lihua.music.shake.ShakeDetector.OnShakeListener;
...
public class MediaService extends Service implements IConstants, OnShakeListener {
	...
	private static final String PAUSE_BROADCAST_NAME = "com.lihua.music.pause.broadcast";
	private static final String NEXT_BROADCAST_NAME = "com.lihua.music.next.broadcast";
	private static final String PRE_BROADCAST_NAME = "com.lihua.music.pre.broadcast";
	private static final int PAUSE_FLAG = 0x1;
	private static final int NEXT_FLAG = 0x2;
	private static final int PRE_FLAG = 0x3;
	private static final int STOP_FLAG = 0x4;
...
//	private Notification mNotification;
	...
	private void updateNotification(Bitmap bitmap, String title, String name) {
		...
		if(bitmap != null) {
			...
			rv.setImageViewResource(R.id.image, R.drawable.albumart_mp_unknown);
		}
